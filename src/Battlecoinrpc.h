...
#ifndef _BATTLECOINRPC_H_
#define _BATTLECOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Battlecoin is not connected
...
/**
 * Battlecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
